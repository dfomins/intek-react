        ...
        <div className="panel-width my-14">
            ...
            <div className="px-10">
                <form className="flex flex-col">
                    ...
                    <input type="text" className="system-input mb-1" value={data.title} maxLength={maxTitleLength} onChange={handleTitleChange} />
                    <p className="mb-4 text-end">
                        {titleCounter}/{maxTitleLength}
                    </p>
                    <label>Saturs</label>
                    <textarea className="system-input min-h-[400px] mb-1 resize-none" value={data.content} maxLength={maxContentLength} onChange={handleContentChange}></textarea>
                    <p className="mb-4 text-end">
