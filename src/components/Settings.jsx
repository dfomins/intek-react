            ...
            <div className="grid md:grid-cols-2 gap-7 text-white">
                ...
                <div className="profile-settings-panel">
                    ...
                    <form>
                        ...
                        <button type="submit" className="p-2 bg-white hover:bg-[#c8d8e4] duration-300 rounded-sm text-black">Atjaunot paroli</button>
                    </form>
                </div>
                <div className="md:col-span-2 profile-settings-panel">
                    ...
                    <form>
                        ...
                        <input className="w-full system-input mb-3" type="text" />
                        <button type="submit" className="p-2 bg-white hover:bg-[#c8d8e4] duration-300 rounded-sm text-black">Saglabāt</button>
                    </form>
                </div>
            </div>
        </div>
